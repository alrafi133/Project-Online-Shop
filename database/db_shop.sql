...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Des 2020 pada 09.14
...
(8, 1, '20201205ZGDF0AMN', '2020-12-05', 'Rizka', '08123456785', 'DKI Jakarta', 'Jakarta Selatan', 'Jln Denpasar No.12', '2113', 'tiki', 'ECO', '4 Hari', 8000, 650, 120000, 128000, 1, 'KTP_Rafi.jpg', 'Rizka', 'BNI', '9821212121484482', 0, NULL),
(9, 1, '20201205AEUVCQLH', '2020-12-05', 'Anis', '081323456543', 'Banten', 'Pandeglang', 'Jln pesamben 4 ', '2113', 'tiki', 'REG', '3 Hari', 17000, 130, 2500000, 2517000, 1, NULL, NULL, NULL, NULL, 0, NULL);
...
--
ALTER TABLE `tbl_rinci_transaksi`
  MODIFY `id_rinci` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
